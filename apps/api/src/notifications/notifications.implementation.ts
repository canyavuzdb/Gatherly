...
export class NotificationsImplementation {
  ...
  async consume(delivery: NotificationDelivery) {
    ...
    const types: Record<Exclude<NotificationDelivery['eventName'], 'event.completed.v1'>, string> = { 'invitation.received.v1': 'INVITATION_RECEIVED', 'invitation.revoked.v1': 'INVITATION_REVOKED', 'attendance.pending.v1': 'ATTENDANCE_REQUESTED', 'attendance.confirmed.v1': 'ATTENDANCE_CONFIRMED', 'attendance.rejected.v1': 'ATTENDANCE_REJECTED', 'attendance.waitlisted.v1': 'ATTENDANCE_WAITLISTED', 'attendance.promoted.v1': 'ATTENDANCE_PROMOTED', 'event.revised.v1': 'EVENT_REVISED', 'event.cancelled.v1': 'EVENT_CANCELLED', 'attendance.finalization-needed.v1': 'ATTENDANCE_FINALIZATION_NEEDED', 'event.review-available.v1': 'EVENT_REVIEW_AVAILABLE', 'organizer-transfer.requested.v1': 'ORGANIZER_TRANSFER_RECEIVED', 'organizer-transfer.accepted.v1': 'ORGANIZER_TRANSFER_ACCEPTED', 'organizer-transfer.declined.v1': 'ORGANIZER_TRANSFER_DECLINED' };
